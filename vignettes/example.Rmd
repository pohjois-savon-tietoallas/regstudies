...
```{r}
# Filter dataset with occurences of hospital visits. If person has been in hospital during the time period two years prior 'postingdate' then those events are included in the filtering.
filtered_d <- d %>% 
...
elixhauser_classes <- read_classes_csv(file = "../data/classification_codes/elixhauser_classes.csv")
...
### Shortcut function for elixhauser classification
