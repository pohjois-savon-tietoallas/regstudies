...
Lets say that we want to find first occasions of disease codes such that we want to obtain first event for eahc individual in each class. We will use Elixhauser classes in this example.
